...
class TagRule(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=False)
    name = db.Column(db.String(100), nullable=False)
    condition_type = db.Column(db.String(20), default="contains")  # contains/exact/regex/amount_gt/amount_lt
    condition_value = db.Column(db.String(255), nullable=False)
    action_type = db.Column(db.String(20), default="tag")  # tag/categorize
